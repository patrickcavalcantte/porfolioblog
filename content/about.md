...
produtos surgem do encontro entre tecnologia, dados e compreensão das
...
| Camada       | Áreas e ferramentas                          |
|--------------|----------------------------------------------|
| Design       | UX/UI, design de produto, prototipagem       |
| Código       | Experimentos interativos, LLMs, automação    |
| Hardware     | Eletrônica, automação, projetos maker, fazer upgrade no PC, montar um PC novo do zero |
| Palavras     | Escrita, literatura brasileira               |
| Protetor de animais | Tenho 18 gatos e uma vira-lata caramelo |
